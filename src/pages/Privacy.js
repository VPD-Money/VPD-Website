                                    ...
                                    <div className="privacy-section-2-content">
                                        ...
                                        <div className="privacy-section-2-content-pod">
                                            ...
                                            <label>
                                                ...
                                                <br/><br/>
                                                Your Phone Contacts<br/><br/>
                                                Contacts may also be transmitted to our system which is subjective to your approval of access. This includes directly managing contacts for lookup or search. Contact details are neither saved, stored or shared to any party or database. <br/>
                                                We provide a variety of services that might require you to enable our app have access to your saved phone contacts in order to better the experience. VPD wallet-wallet transfer and payment link use are both services that require phone contact list so that beneficiaries or recipients and can be suggested either service is in use.
                                            </label>
                                        </div>
