...
class NotFound extends Component {
    ...
    render()
    {
        return <Main title={"404"} description={"404 Not Found"} >
                <HelmetProvider>
                        ...
                        <div className="layer-wrapper">
                            <NavigationLight />
                                  ...
                                  <div className="not-found-group">
                                    <div className="not-found-group-section-1">
                                ...
                                c6.755-0.61,20.546-0.608,41.785,5.087s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z"/>
                                                ...
                                                <g id="planet">
                                                    ...
                                                    <circle id="craterBig" fill="none" stroke="#0E0620" strokeWidth="3"
                                                            strokeMiterlimit="10" cx="548.891"
                                                            cy="62.319" r="13.074"/>

                                                    <circle id="craterSmall" fill="none" stroke="#0E0620" strokeWidth="3"
                                                            strokeMiterlimit="10" cx="591.743"
                                                            cy="158.918" r="7.989"/>
                            ...
                            C360.647,451.083,349.251,457.661,338.164,454.689z"/>
                                                    <g id="antenna">
                                                        <line fill="#FFFFFF" stroke="#0E0620" strokeWidth="3" strokeLinecap="round"
                                                              ...
                                                              strokeMiterlimit="10" x1="323.396" y1="236.625" x2="295.285"
                                                              y2="353.753"/>
                            	...
                            	M269.678,394.912L269.678,394.912c26.3,20.643,59.654,29.585,93.106,25.724l2.419-0.114"/>
                            		...
                            		C333.451,455.886,323.526,457.387,312.957,456.734z"/>
                                                            ...
                                                            <line fill="none" stroke="#0E0620" strokeWidth="3" strokeLinecap="round"
                                                                  strokeLinejoin="round"
                                                                  strokeMiterlimit="10" x1="304.883" y1="486.849" x2="330.487"
                                                                  y2="493.713"/>
                                                        </g>
                                                        <g id="legL">
                            		...
                            		C278.993,441.286,286.836,447.55,296.315,452.273z"/>
                                                            ...
                                                            <line fill="none" stroke="#0E0620" strokeWidth="3" strokeLinecap="round"
                                                                  strokeLinejoin="round"
                                                                  strokeMiterlimit="10" x1="262.638" y1="475.522" x2="288.241"
                                                                  y2="482.387"/>
                                                        </g>
                                                    </g>
                                                    <g id="head">
                                                        ...
                                                        <ellipse transform="matrix(0.259 -0.9659 0.9659 0.259 -51.5445 563.2371)"
                                                                 fill="#FFFFFF"
                                                                 stroke="#0E0620" strokeWidth="3" strokeLinecap="round"
                                                                 strokeLinejoin="round"
                                                                 strokeMiterlimit="10" cx="341.295" cy="315.211" rx="61.961"
                                                                 ry="60.305"/>
                            	...
                            	s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z"/>
                                    ...
                                    <div className="not-found-group-section-2">
                                        <h1>404</h1>
    ...
    componentDidMount()
    {
        $(document).on("click", ".not-found-group-section-2 button", function () {
        ...
        var code = 'gsap.set("svg", { visibility: "visible" });\n' +
            'gsap.to("#headStripe", {\n' +
            '  y: 0.5,\n' +
            '  rotation: 1,\n' +
            '  yoyo: true,\n' +
        ...
        setTimeout(function () {
            try {
                babelScript.appendChild(document.createTextNode(code));
                document.body.appendChild(babelScript);
            } catch (e) {
                babelScript.text = code;
                document.body.appendChild(babelScript);
            }
        },3000);
...
export default attachDeviceTypeHook(NotFound);
